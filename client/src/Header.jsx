...
export default function Header() {
  ...
  return (
    ...
    <div className="flex items-center gap-2  border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
        <div>Anywhere</div>
        <div className="border border-left border-gray-300 h-full"></div>
        <div>Any week</div>
        <div className="border border-left border-gray-300 h-full"></div>
        <div>Add guests</div>
    ...
    <Link to={'/login'} className="flex gap-2 items-center border border-gray-300 rounded-full py-2 px-4 shadow-md ">
